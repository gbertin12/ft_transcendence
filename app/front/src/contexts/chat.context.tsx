...
export const ChatContextProvider: React.FC<any> = ({ children }) => {
    ...
    useEffect(() => {
        const fetchChannels = async () => {
            axios.get("http://bess-f1r2s5:3000/channel/all", 
            {
        ...
        const fetchFriends = async () => {
            axios.get("http://bess-f1r2s5:3000/friends/", { withCredentials: true })
            .then((res) => {
                if (res.status !== 200) return ;
        ...
        const fetchBans = async () => {
            try {
                axios.get("http://bess-f1r2s5:3000/punishments/active", 
                {
                    withCredentials: true,
                    validateStatus: () => true,
                })
